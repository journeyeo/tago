    ...
    <section className="bg-white py-24 px-4">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <div className="flex flex-col items-center gap-4">
          <LineButton size="lg" label={t.ctaSection.button} />

          {/* LINE ID badge */}
          <div className="inline-flex items-center gap-2 bg-gray-50 border border-gray-200 rounded-full px-5 py-2.5">
            ...
            <span className="text-gray-600 text-sm font-medium">{t.ctaSection.lineId}</span>
          </div>
        </div>
      </div>
    </section>
